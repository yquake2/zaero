...
extern void shrapnel_touch ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void sentien_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void barrier_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void Use_PlasmaShield ( edict_t * ent , const gitem_t * item ) ;
extern void PlasmaShield_killed ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
extern void PlasmaShield_die ( edict_t * self ) ;
extern qboolean EMPNukeCheck ( const edict_t * ent , const vec3_t pos ) ;
...
extern void Use_Visor ( edict_t * ent , const gitem_t * item ) ;
...
extern void updateVisorHud ( const edict_t * ent ) ;
...
extern void hound_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void hound_jump_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void handler_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void zboss_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
extern void FireDeadGrapple ( edict_t * self ) ;
extern void DeadHookTouch ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void Plasmaball_Touch ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void HookTouch ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void monster_autocannon_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern char * COM_FileExtension ( const char * in ) ;
...
extern edict_t * PlayerTrail_PickNext ( const edict_t * self ) ;
extern edict_t * PlayerTrail_PickFirst ( const edict_t * self ) ;
...
extern void Drop_Visor ( edict_t * ent , const gitem_t * item ) ;
...
extern int CheckArmor ( edict_t * ent , vec3_t point , const vec3_t normal , int damage , int te_sparks , int dflags ) ;
extern void SpawnDamage ( int type , const vec3_t origin , const vec3_t normal ) ;
extern void Killed ( edict_t * targ , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
