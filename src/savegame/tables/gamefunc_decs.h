...
extern void zboss_die (edict_t *, edict_t *, edict_t *, int, const vec3_t);
...
extern void handler_die (edict_t *, edict_t *, edict_t *, int, const vec3_t);
extern void hound_die (edict_t *, edict_t *, edict_t *, int, const vec3_t);
...
extern void sentien_die (edict_t *, edict_t *, edict_t *, int, const vec3_t);
...
extern void monster_autocannon_die (edict_t *, edict_t *, edict_t *, int, const vec3_t);
extern void PlasmaShield_killed (edict_t *, edict_t *, edict_t *, int, const vec3_t);
// pain
extern void actor_pain (edict_t *, edict_t *, float, int);
extern void berserk_pain (edict_t *, edict_t *, float, int);
extern void zboss_pain (edict_t *, edict_t *, float, int);
...
extern void handler_pain (edict_t *, edict_t *, float, int);
extern void hound_pain (edict_t *, edict_t *, float, int);
...
extern void sentien_pain (edict_t *, edict_t *, float, int);
...
extern void monster_autocannon_pain (edict_t *, edict_t *, float, int);
extern void camera_pain (edict_t *, edict_t *, float, int);
extern void barrier_pain (edict_t *, edict_t *, float, int);
extern void tripbomb_pain (edict_t *, edict_t *, float, int);
// prethink
...
extern void Think_SmoothAccelMove (edict_t *);
extern void plat_go_down (edict_t *);
extern void rotating_think (edict_t *);
...
extern void target_explosion_explode_think (edict_t *);
...
extern void HookDragThink (edict_t *);
extern void HookThink (edict_t *);
extern void PlasmaballBlastAnim (edict_t *);
extern void Plasmaball_Explode (edict_t *);
...
extern void monster_autocannon_explode (edict_t *);
extern void monster_autocannon_think (edict_t *);
extern void monster_autocannon_activate (edict_t *);
extern void monster_autocannon_deactivate (edict_t *);
extern void monster_autocannon_usestub (edict_t *);
extern void securitycamera_think (edict_t *);
extern void empnukeFinish (edict_t *);
extern void empBlastAnim (edict_t *);
extern void PlasmaShield_die (edict_t *);
extern void barrier_think (edict_t *);
extern void trigger_laser_on (edict_t *);
extern void trigger_laser_think (edict_t *);
extern void Anim_CommDish (edict_t *);
extern void TripBomb_Explode (edict_t *);
extern void tripbomb_laser_think (edict_t *);
extern void tripbomb_laser_on (edict_t *);
extern void turnOffGlow (edict_t *);
extern void tripbomb_think (edict_t *);
extern void create_tripbomb_laser (edict_t *);
extern void scexplode_think (edict_t *);
extern void flare_think (edict_t *);
extern void weapon_a2k_exp_think (edict_t *);
// touch
...
extern void HookTouch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
extern void Plasmaball_Touch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
extern void DeadHookTouch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
extern void hound_jump_touch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
extern void mutant_jump_touch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
extern void barrier_touch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
extern void shrapnel_touch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
// use
...
extern void trigger_zboss (edict_t *, edict_t *, edict_t *);
extern void Use_Boss3 (edict_t *, edict_t *, edict_t *);
extern void monster_autocannon_use (edict_t *, edict_t *, edict_t *);
extern void use_securitycamera (edict_t *, edict_t *, edict_t *);
extern void Use_CommDish (edict_t *, edict_t *, edict_t *);
extern void use_tripbomb (edict_t *, edict_t *, edict_t *);
// blocked
...
extern void zboss_stand (edict_t *);
...
extern void handler_stand (edict_t *);
extern void hound_stand (edict_t *);
...
extern void sentien_stand (edict_t *);
...
extern void zboss_walk (edict_t *);
...
extern void handler_stand (edict_t *);
extern void hound_walk (edict_t *);
...
extern void sentien_walk (edict_t *);
...
extern void handler_attack (edict_t *);
extern void hound_run (edict_t *);
...
extern void sentien_run (edict_t *);
...
extern void zboss_melee (edict_t *);
...
extern void hound_attack (edict_t *);
extern void mutant_melee (edict_t *);
// monsterinfo.attack
extern void actor_attack (edict_t *);
extern void zboss_attack (edict_t *);
...
extern void handler_attack (edict_t *);
extern void hound_jump (edict_t *);
...
extern void sentien_attack (edict_t *);
...
extern qboolean hound_checkattack (edict_t *);
...
extern void zboss_sight (edict_t *, edict_t *);
...
extern void handler_sight (edict_t *, edict_t *);
extern void hound_sight (edict_t *, edict_t *);
